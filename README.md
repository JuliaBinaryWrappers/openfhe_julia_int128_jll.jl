# `openfhe_julia_int128_jll.jl` (v0.3.10+0)

[![deps](https://juliahub.com/docs/openfhe_julia_int128_jll/deps.svg)](https://juliahub.com/ui/Packages/General/openfhe_julia_int128_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/efa1e9c6105cd4b9916de52ae93623eac29ec4d0/O/openfhe_julia_int128/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `openfhe_julia_int128_jll.jl` have been built from these sources:

* git repository: https://github.com/hpsc-lab/openfhe-julia.git (revision: `34575a0f17fc239bd5add813de077c8fdf11440b`)
...
`openfhe_julia_int128_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `openfhe_julia_int128_jll.jl`:

* [`CompilerSupportLibraries_jll`](https://github.com/JuliaBinaryWrappers/CompilerSupportLibraries_jll.jl)
* [`LLVMOpenMP_jll`](https://github.com/JuliaBinaryWrappers/LLVMOpenMP_jll.jl)
* [`OpenFHE_int128_jll`](https://github.com/JuliaBinaryWrappers/OpenFHE_int128_jll.jl)
