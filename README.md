# `openfhe_julia_int128_jll.jl` (v0.5.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/78aabf25d1f07ad5a71b722de4d72fef2b092ebc/O/openfhe_julia_int128/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/hpsc-lab/openfhe-julia.git (revision: `d9cfc27e3d39b9607aa8042a32c48d455316cd9e`)
