# `openfhe_julia_int128_jll.jl` (v0.4.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5b09d619cc347b15d6c8794226208cc53fbb2ee1/O/openfhe_julia_int128/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/hpsc-lab/openfhe-julia.git (revision: `afd163ce8ba0ce9538dc9a7e62a9b1c7afc4f4c1`)
