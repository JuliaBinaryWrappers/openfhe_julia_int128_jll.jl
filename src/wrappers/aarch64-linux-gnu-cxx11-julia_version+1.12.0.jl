# Autogenerated wrapper script for openfhe_julia_int128_jll for aarch64-linux-gnu-cxx11-julia_version+1.12.0
...
JLLWrappers.@declare_library_product(libopenfhe_julia, "libopenfhe_julia.so.0.6")
function __init__()
